 ...
 */
contract PickOne_Mock is VRFConsumerBaseV2Plus {
    ...
    uint256 public latestDrawnNumber = 777;
    ...
    modifier onlyAdmin() {
        require(tx.origin == admin, "You are not the owner");
        _;
    }
    ...
    function fulfillRandomWords(
        ...
        // two numbers between 0 - 99
        latestDrawnNumber = randomWords[0] % 99;
    }
}